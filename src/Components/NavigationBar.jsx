...
const NavigationBar = ( { status, current } ) => {
  ...
  <ul className='flex justify-center'>
    ...
    <Link to="/"> <li className="bg-green-300 rounded-lg p-1 text-sm m-1 text-blue-900 hover:font-black">🏡Home</li> </Link> 
      <Link to="about"> <li className="bg-green-300 rounded-lg p-1 text-sm m-1 text-blue-900 hover:font-black">❓About</li> </Link> 
      {(current.country === undefined) ? null : (<Link to="regions"> <li className="bg-green-300 rounded-lg p-1 text-sm m-1 text-blue-900 hover:font-black">🌏Globe</li> </Link>)}
